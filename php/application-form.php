...
$to_email = "admin@wipa.co.za";// email address to which the form data will be sent
...
$sql = "SELECT * FROM womaninpowerapplications";
...
if( mail($to_email, $subject, $email_body, $headers) ) {
	...
	// print_r($name . $surname . $contact_number . $age . $email . $occupation . $nature_work . $goals_ambitions . $expected_results . $ideal_mentor );
	...
	$sql = "INSERT INTO womaninpowerApplications (firstname, surname, contact, age, email, occupation, natureofwork, goals, expectedresults, idealmentor) VALUES
