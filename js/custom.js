...
/* --------------------------------------------
	Mentorship Board
	-------------------------------------------- */	
let viewBio = document.querySelectorAll('.view-bio');

for(let i=0; i<viewBio.length; i++){
	viewBio[i].addEventListener('click', function(){
		viewBio[i].parentNode.classList.toggle('active')
	})
}