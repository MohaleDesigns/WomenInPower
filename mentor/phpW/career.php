...
$to_email = "jason@dithetogroup.co.za"; // email address to which the form data will be sent
$subject = "Job Application Contact Request"; // subject of the email that is sent
...
$headers = 'From: webmaster@dithetogroup.co.za' . "\r\n" .
    'Reply-To: jason@dithetogroup.co.za' . "\r\n" .
...
<html>
	<head>
		<title>Ditheto Group Carrer Form </title>
	</head>
	<body>
